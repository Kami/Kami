...
Currently I'm building a high performance, scalable and affordable logging SaaS at
[Scalyr](https://scalyr.com/). I'm also an [Apache Software Foundation](https://apache.org)
member, contributor to the [Apache Libcloud](https://libcloud.apache.org) project and one of
the early employees and contributor to [StackStorm](https://stackstorm.com/) event driven
infrastructure automation platform.

Hobbies include petting dogs (tell your dog I said hi!), hacking on software and open source
projects, ham radio, flying planes, gym and more.
